...
namespace UnityEditor
{
    ...
    internal class ThreeColorStandardShaderGUI : ShaderGUI
{
	...
	private static class Styles
	{
        ...
        // new stuff
        public static string priColorText = "Primary color";
        public static string secColorText = "Secondary color";
        public static string terColorText = "Tertiary color";
        public static GUIContent colormaskText = new GUIContent("Colormask", "Tint mask Primary (R), Secondary (G), Tertiary (B)");
    ...
    // New stuff
    MaterialProperty primaryColor = null;
    MaterialProperty secondaryColor = null;
    MaterialProperty tertiaryColor = null;
	...
	public void FindProperties (MaterialProperty[] props)
	{
        ...
        // New Stuff
        primaryColor = FindProperty("_PriColor", props);
        secondaryColor = FindProperty("_SecColor", props);
        tertiaryColor = FindProperty("_TerColor", props);
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
            ...
            m_MaterialEditor.ColorProperty(primaryColor, Styles.priColorText);
            m_MaterialEditor.ColorProperty(secondaryColor, Styles.secColorText);
            m_MaterialEditor.ColorProperty(tertiaryColor, Styles.terColorText);
